...
public class OnlyDisplay extends javax.swing.JFrame {
...
//port name   //time out/// data rate// serial port
    ...
    private void jButtonEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEnviarActionPerformed
        EnviarDatos_DISPLAY(jTextFieldMensaje.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlyDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnlyDisplay().setVisible(true);
            }
        });
    }
