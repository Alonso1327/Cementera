...
public class jfProductos extends javax.swing.JFrame {
    ...
    void Cargar (String Valor)
    {
        String Consulta = "select * from Productos "
                ...
                + "like '%" + Valor + "%'"; //Esos comodines indican que el buscador arrojará los
        //resultados de la búsqueda no importanto las letras que tenga adelate o atras, por ejemplo
        //si buscamos ju, el buscador mostrara todos los campos que teng ju
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "PRODUCTOS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
